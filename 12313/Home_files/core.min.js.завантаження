 ...
 */
!function(t,e,a,n){var r=function(e,a){this.$element=t(e),this.options=t.extend({},r.Defaults,a),this.initialize()};r.Defaults={handler:"bat/rd-search.php",maxLive:5},r.prototype.initialize=function(){var e=this,a=t(".rd-navbar-search-results");if(t(".rd-navbar-search-form-input").find("input").val("").on("keyup input propertychange",function(){var a=t(this).val().trim();""!==a?t.get(e.options.handler,{s:a,liveSearch:"true",liveCount:e.options.maxLive,dataType:"html"},function(e){t(".rd-navbar-live-search-results").html(e).addClass("not-empty")}):t(".rd-navbar-live-search-results").html("").removeClass("not-empty")}),a.length){var n=location.search.replace(/^\?.*s=([^&]+)/,"$1");t.get(e.options.handler,{s:decodeURI(n),liveSearch:"false",dataType:"html"},function(t){a.html(t)})}},t.fn.RDSearch=function(e){return this.each(function(){t(this).data("rdsearch")||t(this).data("rdsearch",new r(this,e))})},t.fn.RDSearch.Constructor=r}(window.jQuery,window,document);
	...
	(function (c, n, m) {
		...
		l = function () {
			...
			d.prototype.closeToggle = function (a, b) {
				...
				}), d || (e.add(this).removeClass("active").scrollTop( 0 ), a.options.callbacks.onToggleClose && a.options.callbacks.onToggleClose.call(this, a)));
				return this
			};
...
//Custom Scroll To
!function(o){o.fn.scrollTo=function(){o(this).find('a[href^="#"]').on("click",function(n){o(this).addClass("active");var i=this.hash,t=o(i);o("html, body").stop().animate({scrollTop:t.offset().top+2},1e3,"swing",function(){window.location.hash=i})})}}(jQuery);
